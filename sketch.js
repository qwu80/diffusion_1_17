...
//arrow up 
line((10+100+70+change_square+940-change_length-70-20+4)*s_x,(10+385/2+96.25+3)*s_y,(10+100+70+change_square+790)*s_x,(10+385/2+96.25)*s_y)
line((10+100+70+change_square+940-change_length-70-20+4)*s_x,(10+385/2+96.25-3)*s_y,(10+100+70+change_square+790)*s_x,(10+385/2+96.25)*s_y)
//arrow down up
...
//box
   ...
   textSize(10);
   text("3",(278)*s_x,(25)*s_y)

textSize(14);
  
text("Concentration (/cm )",(160)*s_x,(30)*s_y)


text("Current (Amp)",(160)*s_x,(223)*s_y)
text("x",(930)*s_x,(190)*s_y)
text("x",(930)*s_x,(318)*s_y)
...
line((10+100+70+change_square+940-change_length-70-760-20)*s_x,(10+385/2+96.25-70)*s_y, (10+100+70+change_square+940-change_length-70-760-20+3)*s_x, (10+385/2+96.25-60-5)*s_y)
  ...
  // for ( var i = 0; i < point_count; i++ ) {
    // if (i==0 ) {
      curveVertex(170*s_x,(171.25-array_plot_h_0.length*0.7)*s_y)
      curveVertex(170*s_x,(171.25-array_plot_h_0.length*0.7)*s_y)
      // curveVertex(190*s_x,(171.25-array_plot[0].length*0.7)*s_y)
    ...
    for (var k = 0; k < point_count; k++) {
      // if (i!=(point_count-1)||i!=(0)) {
        curveVertex((190+k*(950-190)/point_count)*s_x,(171.25-array_plot_h[k].length*0.7)*s_y)
      // }
    }
   
    // if (i==(point_count-1)) {
      curveVertex((950-(950-190)/point_count)*s_x,(171.25-array_plot_h[point_count-1].length*0.7)*s_y)
    // }
  // }
...
setTemperature_real = (te) => {
  ...
  // 
  scattering_velocity = constant_temperature_real/30
  for (let i=0; i < whiteArray.length; i ++){
...
setTest = (v) => {
  ...
  test_x_scale = v*0.1
  document.getElementById("scale_2").value=Math.round((v*0.1*100))/100
}
...
//   document.getElementById("speed_1").value=1
//   document.getElementById("speed_2").value=1
